<h2><a href="https://leetcode.com/problems/count-substrings-with-only-one-distinct-letter/description/?envType=problem-list-v2&envId=math">1279. Prime Arrangements</a></h2><h3>Easy</h3><hr><p>Return the number of permutations of 1 to <code>n</code> so that prime numbers are at prime indices (1-indexed.)</p>
