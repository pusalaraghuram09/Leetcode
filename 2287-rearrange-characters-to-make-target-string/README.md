<h2><a href="https://leetcode.com/problems/rearrange-characters-to-make-target-string/?envType=problem-list-v2&envId=hash-table">2372. Rearrange Characters to Make Target String</a></h2><h3>Easy</h3><hr><p>You are given two <strong>0-indexed</strong> strings <code>s</code> and <code>target</code>. You can take some letters from <code>s</code> and rearrange them to form new strings.</p>
